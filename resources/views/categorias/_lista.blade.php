        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('categorias.edit', ['id' => $categoria->id]) }}"
                    class=" btn-sm btn-outline-primary edit-categoria">
                ...
                <form action="{{ route('categorias.destroy', $categoria->id) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn-sm delete-categoria btn-outline-danger"
                        data-id="{{ $categoria->id }}" style="border: none; background: none; padding: 0;">
